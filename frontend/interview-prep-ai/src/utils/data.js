...
export const APP_FEATURES = [
    {
        ...
        description:"Get interview questions that match your job role and skill level.",
    },
    {
        id:"02",
        title:"Learn at Your Own Pace",
        description:"Expand answers only when you're ready to dive deeper.",
    },
    {
        id:"03",
        title:"Capture Your Progress",
        description:"Add personal notes to questions for future reference.",
    },
    {
        id:"04",
        title:"Understand the WHY behind answers", 
        description:"Beyond just answers, get insights into the reasoning behind them.",
    },
    {
        id:"05",
        title:"Save, Organize and Revisit",
        description:"Easily save and categorize questions for later review.",
    },
